"""
Django settings for rotenbirben project.
"""
...
ALLOWED_HOSTS = ['abo.rotenbirben.ch','rotenbirben.juntagrico.science', 'localhost',]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','rotenbirben.db'), 
...
WSGI_APPLICATION = 'rotenbirben.wsgi.application'
